...
# Script to run HypO and ERM with PLAIN AugMix on DenseNet121
...
CONFIGS=(
    "hypo train_plain_augmix.py densenet121_hypo_plain_augmix"
    "erm train_plain_augmix.py densenet121_erm_plain_augmix"
)

echo "Starting multiple seed training runs with plain AugMix for DenseNet121..."
...
echo "All specified plain AugMix training runs for DenseNet121 completed."
