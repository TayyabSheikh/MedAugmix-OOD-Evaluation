...
# Script to train HypO on Fitzpatrick17k with MedMNIST-C style AugMix (using dermamnist)
...
FEAT_DIM=128
LOSS_TYPE="hypo"
TRIAL="hypo_medmnistc_dermamnist_0" # Specific trial name
HEAD="mlp"
WEIGHT_DECAY=1e-4
MOMENTUM=0.9
PREFETCH=4
...
AUGMENT_TRAIN=False # Dataloader ignores this if use_med_augmix is True

# Construct the command
echo "Running HypO training script for Fitzpatrick17k with MedMNIST-C (dermamnist) AugMix..."
echo "Command:"
...
echo "HypO training script for Fitzpatrick17k with MedMNIST-C (dermamnist) AugMix finished."
